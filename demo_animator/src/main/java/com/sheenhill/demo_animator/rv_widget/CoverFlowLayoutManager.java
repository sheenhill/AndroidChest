...
public class CoverFlowLayoutManager extends RecyclerView.LayoutManager {
    ...
    public CoverFlowLayoutManager(){
        this(false,false,true,1f,true,true);
    }
...
//        cm.setSaturation(0.9f);
    ...
    /**
     * 该方法主要用于RecyclerCoverFlow#getChildDrawingOrder(int, int)判断中间位置
    ...
    /**
     * 获取中间位置
     * <p>Note:该方法主要用于RecyclerCoverFlow#getChildDrawingOrder(int, int)判断中间位置
