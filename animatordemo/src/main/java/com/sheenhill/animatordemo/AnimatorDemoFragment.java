...
//        final int distance = 3000;// 这个是应该在1920左右
        final float scale = getResources().getDisplayMetrics().density * distance;
        colors=new String[]{"#FF0000","#FF7F00","#FFFF00","#00FF00","#00FFFF","#0000FF","#8B00FF","#FF0000","#FF7F00","#FFFF00","#00FF00","#00FFFF"};
...
//                setEndAction(s6,s7);
    ...
    private void setAnimatorTargets(AnimatorSet animationSet,View[] views){
        for (int i = 0; i < views.length; i++) {
            animationSet.setTarget(views[i]);
        }
    }
}
