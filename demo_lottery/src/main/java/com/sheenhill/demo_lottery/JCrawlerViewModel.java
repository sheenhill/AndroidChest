...
import com.sheenhill.demo_lottery.data_repository.J_LuckNumberGenerator;
import com.sheenhill.demo_lottery.data_repository.LuckNumberGeneratorKt;
...
//                LogUtil.i("list:"+arr);
    ...
    public void updateLuckyNumByDB() {
        ...
        list.add(J_LuckNumberGenerator.getTicket());
